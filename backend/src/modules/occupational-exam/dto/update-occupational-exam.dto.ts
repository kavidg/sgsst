 ...
 */
@ValidatorConstraint({ name: 'FollowUpDateRequiredUpdate', async: false })
 ...
 */
@ValidatorConstraint({ name: 'ExamDateRequiredForCompletedUpdate', async: false })
...
export class UpdateOccupationalExamDto {
