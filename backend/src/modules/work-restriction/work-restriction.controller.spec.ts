...
/**
 * FASE 33 — Tests de seguridad del controller 3.1.6 (SEC-001..007).
 *
 * Patrón 3.1.5 (occupational-medical-record-custody.controller.spec.ts):
 * controller con dependencias mockeadas + GUARDS REALES (FirebaseAuthGuard +
 * RolesGuard) con sus dependencias internas mockeadas.
 *
 * Matriz de roles 3.1.6:
...
describe('WorkRestrictionController — seguridad 3.1.6 (FASE 33)', () => {
  let controller: WorkRestrictionController;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        { provide: WorkRestrictionService, useValue: workRestrictionService },
    ...
    controller = module.get(WorkRestrictionController);
